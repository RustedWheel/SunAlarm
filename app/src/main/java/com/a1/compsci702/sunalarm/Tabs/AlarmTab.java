...
public class AlarmTab extends Fragment {
    ...
    private static final String ARG_PARAM1 = DXDecryptorP1ZRD3xu.decode("2xKJCFTx");

    private static final String ARG_PARAM2 = DXDecryptorP1ZRD3xu.decode("2xKJCFTy");
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            throw new RuntimeException(context.toString() + DXDecryptorP1ZRD3xu.decode("ix6OGk3g8VR+uiNdgnHEwdF568WeCbMbgWyjbNTlI8Ix4PBMmyhKIcPKPZL9"));
        }
    }
...
class DXDecryptorP1ZRD3xu {
    ...
    static String kp = ds(new String[]{"Zw==", "aw==", "SQ==", "TA==", "TA==", "cA==", "Nw==", "cw==", "WA==", "aA==", "cg==", "Tg==", "Yw==", "Ng==", "OA==", "MA=="});
