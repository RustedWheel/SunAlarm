...
public final class DateConverter {
    ...
    public static String dateToString(Date date) {
        return date.getYear() + DXDecryptorYE6RiNIF.decode("/g==") + /*"0"*/
        date.getMonth() + DXDecryptorYE6RiNIF.decode("/g==") + /*"0"*/
        date.getDate();
    }
...
class DXDecryptorYE6RiNIF {
    ...
    static String kp = ds(new String[]{"SQ==", "aA==", "Tw==", "bA==", "bg==", "aA==", "NQ==", "Wg==", "aA==", "dg==", "MQ==", "Zg==", "OA==", "dA==", "UA==", "Vg=="});
