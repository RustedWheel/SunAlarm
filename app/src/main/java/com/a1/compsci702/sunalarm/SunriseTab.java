...
public class SunriseTab extends Fragment {
    ...
    private static final String ARG_PARAM1 = DXDecryptorfleybX7G.decode("Ox70+aR3");

    private static final String ARG_PARAM2 = DXDecryptorfleybX7G.decode("Ox70+aR0");
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            throw new RuntimeException(context.toString() + DXDecryptorfleybX7G.decode("axLz671mCHKFWOFXJAVeOEB5am+Gi3e7ogKepoIp/wqeBjdjJPBRxQb+3M9F"));
        }
    }
...
class DXDecryptorfleybX7G {
    ...
    static String kp = ds(new String[]{"SA==", "bw==", "NQ==", "WQ==", "bA==", "SQ==", "WQ==", "RA==", "Uw==", "Nw==", "dw==", "VQ==", "bw==", "Vw==", "NA==", "Mg=="});
